...
public class testTDD {
    ...
    public void givenUserId_shouldReturnInvoice() {
        CabMethods cabService = new CabMethods();
        cabService.totalFare("Abc", CabMethods.type.Normal, 5, 0);
        cabService.totalFare("Abc", CabMethods.type.Normal, 10, 1);
        cabService.totalFare("Abc", CabMethods.type.Premium, 5, 9);

        long total = cabService.rideRepostitory("Abc").totalAmount;
        System.out.println(total);
        Assert.assertEquals(170, total);
